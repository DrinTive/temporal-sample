...
WorkflowHandle<TempAlertWorkflow> handle = await client.StartWorkflowAsync(
    (TempAlertWorkflow wf) => wf.RunAsync(thresholdDelta, thresholdTimeWindow, responseWaitWindow),
